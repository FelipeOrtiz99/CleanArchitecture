...
namespace CleanArchitecture.Identity
{
    ...
    {
        public static IServiceCollection ConfigureIndetityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddAuthentication(options =>
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    ValidIssuer = configuration["JwSettings:Issuer"],
                    ValidAudience = configuration["JwSettings:Audience"],
